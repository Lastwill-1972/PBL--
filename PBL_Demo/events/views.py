...
=======
    ...
    liked_comment_ids = [like.comment_id for like in CommentLike.objects.filter(user=user, comment__in=comments)]
...
def public_events(request):
    ...
    return render(request, 'events/public_events.html', {'events': events, 'user': user})
>>>>>>> 7c97f9c (feat:评论功能)
